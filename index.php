...
<head>
    ...
    <title>Testiranje REST API-a 2023</title>
...
<body>
    ...
    <form action="." method="post" onsubmit="">
        ...
        <!-- !!!ovde ne sme da bude razmaka jer se u js proverava innerHTML != "" -->
        <pre id="get_odgovor"><?php if (isset($_SESSION['get_odgovor'])) {
                echo json_encode($_SESSION['get_odgovor'], JSON_PRETTY_PRINT);
            }unset($_SESSION['get_odgovor']); ?></pre>
        <label id="server_message"><?php if (isset($_SESSION['message'])) {
        ...
        <div id="novosti_post">
            ...
            <select name="kategorija_odabir" id="kategorija_odabir">
                <?php
                $mydb->select("kategorija", "*", join_table: null);
                if (((object) $mydb)->result != null):
                    while ($red = $mydb->result->fetch_object()):
                        ?>
        ...
        <div id="kategorije_put">
            <input type="text" name="id_kategorije" id="id_kategorije" placeholder="Unesite id kategorije koju menjate">
        ...
        <div id="novosti_put">
            <input type="text" name="id_novosti" id="id_novosti" placeholder="Unesite id novosti koju menjate">
